...
// =====================================================
// استيراد جميع الكتب بأسمائها الصحيحة
// =====================================================
...
import BOOK_09_UDHIYAH from './books/book_09_udhiya';           // ✅ مصحح
...
import BOOK_15_BUYUU from './books/book_15_buyu';               // ✅ مصحح
import BOOK_16_RIBA from './books/book_16_riba';
import BOOK_17_RAHN from './books/book_17_rahn';
import BOOK_18_SHARIKAH from './books/book_18_sharka';          // ✅ مصحح
...
import BOOK_29_NAWAZIL_TIB from './books/book_29_nawazil_tibbiya';    // ✅ مصحح
import BOOK_30_NAWAZIL_MALIYA from './books/book_30_nawazil_maliya';
import BOOK_31_NAWAZIL_ASR from './books/book_31_nawazil_muasira';     // ✅ مصحح
...
export const FIQH_DATABASE: Book[] = [
  BOOK_01_TAHARA, BOOK_02_SALAH, BOOK_03_JAMAAH, BOOK_04_KHAWF,
  BOOK_05_JANAIZ, BOOK_06_ZAKAH, BOOK_07_SIYAM, BOOK_08_HAJJ,
  BOOK_09_UDHIYAH, BOOK_10_NIKAH, BOOK_11_TALAQ, BOOK_12_RADA,
  BOOK_13_NAFAQAT, BOOK_14_HADANAH, BOOK_15_BUYUU, BOOK_16_RIBA,
  BOOK_17_RAHN, BOOK_18_SHARIKAH, BOOK_19_IJARAH, BOOK_20_GHASB,
  BOOK_21_WAQF, BOOK_22_JIHAD, BOOK_23_HUDUD, BOOK_24_QISAS,
  BOOK_25_QADA, BOOK_26_ADAB, BOOK_27_AKHLAQ, BOOK_28_ZUHD,
  BOOK_29_NAWAZIL_TIB, BOOK_30_NAWAZIL_MALIYA, BOOK_31_NAWAZIL_ASR,
  BOOK_32_USUL, BOOK_33_MAQASID, BOOK_34_QAWAID,
];
...
// تصدير التصنيفات
import { CATEGORIES as OriginalCategories } from '../types/fiqh.types';
